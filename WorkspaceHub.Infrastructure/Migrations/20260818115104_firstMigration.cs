        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkspaceTypes_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkspacePricings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkspacePricings_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkspacePricings_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TenantId_CustomerId_StartAt",
                table: "Bookings",
                columns: new[] { "TenantId", "CustomerId", "StartAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TenantId_WorkspaceId_StartAt_EndAt",
                table: "Bookings",
                columns: new[] { "TenantId", "WorkspaceId", "StartAt", "EndAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_TenantId_BookingId_PaymentDate",
                table: "Payments",
                columns: new[] { "TenantId", "BookingId", "PaymentDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkspacePricings_TenantId",
                table: "WorkspacePricings",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkspacePricings_WorkspaceId_PricingType",
                table: "WorkspacePricings",
                columns: new[] { "WorkspaceId", "PricingType" },
                unique: true,
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workspaces_BranchId_Name",
                table: "Workspaces",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkspaceTypes_TenantId_Name",
